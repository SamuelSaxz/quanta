...
export default function OnboardingFour() {
  ...
  const { questionFour, setQuestionValue } = useOnboarding();
  ...
  return (
    <>
      ...
      >
        Quão fácil é para você manter pequenas rotinas no dia a dia, mesmo
        simples?
      </Text>
